    ...
    <form onSubmit={submit} className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <Section title="Image GC">
        <div className="flex items-center gap-3 mb-3">
          ...
          <span className="text-[12px] text-text-dim">Enable nightly image GC (keeps images used in the last 30 days)</span>
        </div>
        <div className="flex items-center gap-3">
          <Button
            type="button"
      ...
      <Section title="Tools">
        <p className="text-[11px] text-text-dim mb-3">Available in every run across all projects.</p>
        <ChipInput
